    ...
    <main className="bg-white text-[#183814]">
      <section className="section-grid-lines bg-[#0f1c07] pt-28 text-white md:pt-36">
        <div className="container-shell figma-inner grid min-h-[640px] gap-10 py-14 md:py-20 lg:grid-cols-[0.9fr_1fr] lg:items-center">
          ...
          <div className="relative min-h-[420px] overflow-hidden rounded-[24px] border border-white/10 bg-[#071007] shadow-[0_30px_90px_rgba(0,0,0,0.28)]">
            <Image alt="" className="object-cover object-center" fill priority sizes="650px" src="/images/events/community-landscape-group.jpg" />
              ...
              <div className="grid gap-4">
                {communityBenefits.map((benefit) => (
                  <div className="flex gap-4 rounded-[28px] border border-[#d8e4d2] bg-[#f8fbf4] p-6" key={benefit}>
                    <PremiumIcon icon={CheckCircle2} size="sm" tone="green" />
            ...
            <div className="grid gap-8 lg:grid-cols-[0.9fr_1fr] lg:items-stretch">
              <div className="flex flex-col justify-center">
                ...
                <h2 className="mt-4 text-[32px] font-medium leading-tight text-[#082005] md:text-[44px]">
                  Join once. Keep finding the right events.
                </h2>
                ...
                <a className="mx-auto mt-8 inline-flex items-center gap-2 rounded-[18px] bg-[#459c0a] px-6 py-4 font-semibold text-[#061006] transition hover:-translate-y-0.5 hover:bg-[#5dc716] md:mx-0" href={socialLinks.whatsapp}>
                  Join the WhatsApp community <ArrowRight className="size-4" strokeWidth={1.8} />
                </a>
              </div>
              <div className="relative min-h-[420px] overflow-hidden rounded-[26px] border border-[#d8e4d2] bg-[#10240c] lg:h-full">
                <Image alt="" className="object-contain" fill sizes="760px" src="/images/events/last-dance-crew.jpg" />

        ...
        return (
          ...
          >
            <div className="flex items-center gap-3 text-sm font-bold uppercase tracking-[0.18em] text-white/62">
              <span className="grid size-11 place-items-center rounded-full bg-white/10 text-[#b8ff2c]">
            ...
            {index === 2 ? (
              ...
              <CalendarDays className="hidden size-7 text-white/26 transition group-hover:text-[#b8ff2c] md:block" />
            )}
          </motion.div>
        );
      })}

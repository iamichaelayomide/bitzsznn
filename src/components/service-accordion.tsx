...
const servicePanels = [
  ...
  {
    image: "/images/events/pop-apocalypse-brand-wall.jpg",
    stats: [
  ...
  {
    image: "/images/events/pop-rave-dj.jpg",
    stats: [
  ...
  {
    image: "/images/events/pop-rave-dj-booth-wide.jpg",
    stats: [
          ...
          return (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <PremiumIcon className="transition group-hover:border-[#b9d7ad] group-hover:bg-[#eef8ea]" icon={RowIcon} size="sm" tone={isOpen ? "green" : "light"} />
                <span className="flex-1 text-lg font-semibold text-[#183814] md:text-2xl">{item.title}</span>
                <span className="grid size-10 shrink-0 place-items-center rounded-[14px] border border-[#dbe6d7] bg-white shadow-[inset_0_1px_0_rgba(255,255,255,0.9)]">
                  <Plus className={`size-5 transition duration-200 ${isOpen ? "rotate-45 text-[#4b8d16]" : ""}`} strokeWidth={1.8} />
                </span>
              </div>
          ...
          >
            <div className="relative min-h-[230px] overflow-hidden">
              ...
              <div className="absolute bottom-5 left-5 right-5 flex items-end justify-between gap-4">
                <PremiumIcon icon={Icon} size="lg" tone="white" />
              </div>
            </div>

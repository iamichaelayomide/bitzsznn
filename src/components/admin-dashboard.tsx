...
import { Download, LogOut, Mail, Search, Ticket, UsersRound, QrCode, CheckCircle2, type LucideIcon } from "lucide-react";
...
export function AdminDashboard({ rsvps, tickets, rsvpSettings, eventNames }: Props) {
  ...
  return <main className="min-h-screen bg-[#f7f5f2] pt-28 text-[#183814] md:pt-36"><section className="container-shell figma-inner pb-20"><div className="flex flex-col justify-between gap-5 md:flex-row md:items-end"><div><p className="font-mono text-xs font-bold uppercase tracking-[0.18em] text-[#459c0a]">Private dashboard</p><h1 className="hero-title mt-4">Guest operations.</h1><p className="mt-4 text-[#183814]/65">Every RSVP and confirmed Paystack ticket, organized by event.</p></div><div className="flex flex-wrap items-center gap-3"><Link className="inline-flex min-h-11 items-center justify-center gap-2 rounded-[14px] border border-[#d8e4d2] bg-white px-4 text-sm font-bold transition hover:bg-[#f0f6ec]" href="/tickets/check-in"><QrCode className="size-4 text-[#459c0a]" /> Door Check-in</Link><Link className="inline-flex min-h-11 items-center justify-center gap-2 rounded-[14px] border border-[#d8e4d2] bg-white px-4 text-sm font-bold transition hover:bg-[#f0f6ec]" href="/tickets/verify"><CheckCircle2 className="size-4 text-[#459c0a]" /> Verify Ticket</Link><Link className="inline-flex min-h-11 items-center justify-center gap-2 rounded-[14px] border border-[#d8e4d2] bg-white px-4 text-sm font-bold transition hover:bg-[#f0f6ec]" href="/">Main Site</Link><button className="inline-flex min-h-11 items-center justify-center gap-2 rounded-[14px] border border-[#d8e4d2] bg-white px-4 text-sm font-bold transition hover:bg-[#f0f6ec]" onClick={logout}><LogOut className="size-4" /> Sign out</button></div></div>

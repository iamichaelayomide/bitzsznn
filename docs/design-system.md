...
Primary CTAs use green/gold energy against the dark event imagery. Text on dark surfaces uses high-contrast ivory. Muted copy should use `--muted-foreground`, never a random gray.
